...
export default function MagicRings({
  ...
  useEffect(() => {
    ...
    // Use a normalized camera that always covers the screen (-1 to 1)
    ...
    // Quad spanning the full clip space
    ...
    mount.addEventListener('mousemove', onMouseMove as any);
    ...
    return () => {
      ...
      ro.disconnect();
      mount.removeEventListener('mousemove', onMouseMove as any);
