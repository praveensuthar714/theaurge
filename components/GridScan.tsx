...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
  ...
  fragColor = vec4(color, alpha * 0.4); // slightly lower alpha globally for elegance
}
...
export const GridScan: React.FC<GridScanProps> = ({
  ...
  // Update uniforms when props change securely
  useEffect(() => {
  ...
  return (
    <div ref={containerRef} className={`relative overflow-hidden w-full h-full ${className || ''}`} style={style} />
  );
};
